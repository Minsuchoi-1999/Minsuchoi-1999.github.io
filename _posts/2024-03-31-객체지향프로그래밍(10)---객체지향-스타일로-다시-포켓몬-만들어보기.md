...
public:
	void decide_turn(int mobility1, int mobility2) {
	...
	int compare_type(int type, int enemy_type) {
	...
	int do_turn(bukein* mypomon, riako* enem_pomon) {
	...
	int do_turn(bukein* mypomon, chicorita* enem_pomon) {
		if (!is_hit(mypomon->get_accuracy())) {
			cout << mypomon->get_name() << "의 공격은 빗나갔다!" << endl;
		}
		else {
	...
	int do_turn(riako* mypomon, bukein* enem_pomon) {
		if (!is_hit(mypomon->get_accuracy())) {
			cout << mypomon->get_name() << "의 공격은 빗나갔다!" << endl;
		}
		else {
	...
	int do_turn(riako* mypomon, chicorita* enem_pomon) {
		if (!is_hit(mypomon->get_accuracy())) {
			cout << mypomon->get_name() << "의 공격은 빗나갔다!" << endl;
		}
		else {
	...
	int do_turn(chicorita* mypomon, bukein* enem_pomon) {
		if (!is_hit(mypomon->get_accuracy())) {
			cout << mypomon->get_name() << "의 공격은 빗나갔다!" << endl;
		}
		else {
	...
	int do_turn(chicorita* mypomon, riako* enem_pomon) {
		if (!is_hit(mypomon->get_accuracy())) {
			cout << mypomon->get_name() << "의 공격은 빗나갔다!" << endl;
		}
		else {
